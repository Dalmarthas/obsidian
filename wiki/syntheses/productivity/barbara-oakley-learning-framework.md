...
What reusable learning framework does the current Barbara Oakley source add to the vault?

# Answer

The source adds a six-part model:

1. Use focused effort to make first contact with the material.
   Learning starts with direct concentration, not vague exposure.

2. Let diffuse processing connect what focus alone cannot.
   Walks, breaks, sleep, and stepping away help integrate patterns after real effort.

3. Build chunks instead of hoarding loose facts.
   Stable learning means turning pieces into retrievable units that reduce working-memory strain.

4. Test recall instead of trusting familiarity.
   Looking away and reconstructing the idea reveals whether the chunk is actually usable.

5. Use retrieval to make learning less cue-dependent under pressure.
   The newer retrieval-practice source sharpens Oakley's recall claim by suggesting that memories built through repeated retrieval may remain more available when stress later rises.

6. Shrink procrastination by committing to process.
   Short timed sessions reduce the pain of starting and make consistency easier than outcome-heavy dread.

7. Protect the organism that learns.
   Sleep, exercise, and reduced multitasking are part of the learning system, not optional extras.

# Basis

- Main source: [[wiki/sources/2026-04-11-barbara-oakley-learning-how-to-learn|Barbara Oakley Learning How to Learn]]
- Canonical concepts: [[wiki/concepts/productivity/focused-and-diffuse-learning-modes|Focused and Diffuse Learning Modes]], [[wiki/concepts/productivity/chunking|Chunking]], [[wiki/concepts/productivity/effective-practice|Effective Practice]]
...
- Compared with the new PACER source, Oakley is stronger on chunking, attentional modes, and anti-familiarity learning, while PACER is stronger on classifying what is being read so the right digestion move can happen before overload accumulates.
...
- The PACER source sharpens the same branch from another angle: how much forgetting comes not from bad attention during intake, but from failing to route different information types into different post-reading processes?
