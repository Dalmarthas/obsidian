...
What durable productivity framework can be extracted from this Daniel Pink productivity summary?

# Answer

The current source supports a six-part framework:

1. Subtract aggressively.
   Productivity begins by cutting the nonessential, limiting the active list, and choosing one Most Important Task.

2. Match important work to peak cognition.
   Put meaningful work in your prime window instead of donating your best attention to reactive tasks.

3. Systematize the small stuff.
   Batch, automate, and quickly dispatch low-value tasks so they stop taxing the same mind needed for harder work.

4. Make progress visible.
   End-of-day reflection and weekly review create momentum because movement is easier to sustain when it can be seen.

5. Treat recovery as part of output.
   Breaks, movement, and detachment are not rewards after work; they are conditions for good work continuing.

6. Favor repetition over drama.
   Durable productivity comes more from simple consistency than from occasional heroic bursts.

# Basis

- Main source: [[wiki/sources/2026-04-10-daniel-pink-productivity-wisdom|Daniel Pink Productivity Wisdom]]
- Canonical concepts: [[wiki/concepts/productivity/peak-hours|Peak Hours]], [[wiki/concepts/productivity/restorative-breaks|Restorative Breaks]], [[wiki/concepts/productivity/behavior-journaling|Behavior Journaling]], [[wiki/concepts/productivity/samoupravlenie|Samoupravlenie]]
