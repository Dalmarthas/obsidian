...
tags:
  ...
  - business
  - seth-godin
question: What reusable leadership framework does Seth Godin's `Leadership vs. Management` source add to the vault?
basis:
...
What reusable leadership framework does Seth Godin's `Leadership vs. Management` source add to the vault?
...
2. Take responsibility before authority arrives.
   Leadership begins when someone owns a direction and its consequences without hiding behind title, consensus, or permission.

3. Prefer enrollment to coercion.
   Durable leadership creates voluntary participation around a culture or mission instead of forcing compliance.

4. Use process instead of certainty theater.
   Leaders should run experiments, revise quickly, and tolerate being wrong as part of moving through ambiguity.

5. Judge decisions separately from outcomes.
   A bad process can occasionally produce a lucky result, and a sound process can still meet noisy short-run failure.

6. Aim past quality toward excellence.
   Meeting spec is increasingly insufficient as a human advantage; care, judgment, and intentionality create the harder-to-copy layer.

7. Treat so-called soft skills as real skills.
   Empathy, initiative, resilience, responsibility, and trustworthiness are not decorative extras. They are trainable economic and cultural differentiators.

8. Give people a compass, not a map.
   In fast-changing environments, leaders are more useful when they provide principles, direction, and cultural orientation than when they pretend to control every step.

9. Surf changing conditions instead of defending stable-course assumptions.
   The newer source makes leadership more adaptive: some environments are not golf courses to optimize, but waves to read and ride.

10. Redesign around new tools instead of protecting the old model.
   Leadership under technological change is weaker when it treats innovation as a threat to defend against and stronger when it asks what new value becomes possible now.
...
- Main source: [[wiki/sources/2026-04-12-seth-godin-leadership-vs-management-what-it-means-to-make-a-difference|Seth Godin Leadership vs. Management What It Means to Make a Difference]]
- Supporting concepts: [[wiki/concepts/leadership/leadership-vs-management|Leadership vs. Management]], [[wiki/concepts/leadership/leadership|Leadership]], [[wiki/concepts/business/business-strategy|Business Strategy]]
...
- This framework currently rests on a secondary summary rather than a primary transcript.
- The model is strongest for change-heavy, creative, entrepreneurial, and transition environments; it still needs stronger cross-source testing in stable, safety-critical, or highly regulated settings.
