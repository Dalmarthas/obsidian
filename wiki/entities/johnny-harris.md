...
Harris gives the vault a concrete model for explainers and educational storytelling that sits between communication, visual literacy, and audience guidance. His branch is not mainly about persuasion through debate or negotiation. It is about how to make information felt, then understood.

# Evidence In This Vault

- Core storytelling unit: [[wiki/concepts/communication/anchor-bridge-structure|Anchor-Bridge Structure]]
- Communication overlap: [[wiki/concepts/communication/effective-communication|Effective Communication]]
- Writing overlap: [[wiki/concepts/communication/concrete-specificity|Concrete Specificity]]
