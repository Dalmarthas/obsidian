...
Effective practice is structured repetition designed to improve performance rather than merely consume time. In the current vault, it means focused, accurate, feedback-sensitive repetitions carried out with enough attention, challenge, and recovery that the nervous system actually learns from them. The concept is narrower than `working hard` and more concrete than `practice more`.

# Why It Matters

- It gives the productivity branch a quality standard for practice, not just a persistence standard.
- It explains why two people can spend the same amount of time and improve at very different rates.
- It adds a cleaner bridge between neuroscience claims about adaptation and the day-to-day design of learning sessions.

# Evidence In This Vault

- The current source argues that practice changes performance by strengthening neural pathways, with myelination presented as one mechanism.
- It treats slow, correct repetitions as more valuable than rushed repetitions that encode bad coordination.
...
- The newer Greene source sharpens the `what counts` question:
  ...
  - repetitions should target weak points rather than recycle strengths
...
- Compared with [[wiki/concepts/productivity/rapid-skill-acquisition|Rapid Skill Acquisition]], effective practice is narrower. Rapid skill acquisition is the broader strategy for getting to usable competence quickly; effective practice is the quality standard inside the repetitions themselves.
- Compared with [[wiki/concepts/productivity/deliberate-practice|Deliberate Practice]], effective practice is broader and less severe. Deliberate practice names targeted weakness-removal at the edge of competence; effective practice includes that layer but also covers pacing, attention, rest structure, and the general conditions that make repetitions learnable.
