...
Peak hours is the principle of identifying the period of the day when one's attention, judgment, and cognitive sharpness are strongest, then reserving that window for the most meaningful or difficult work. In the current vault, it is not a generic deep-work slogan. It is chronotype-aware scheduling as a practical resource-allocation rule.

# Why It Matters

- It raises productivity by matching task difficulty to real cognitive capacity rather than idealized plans.
- It protects important work from being crowded out by reactive or low-value tasks.
- It gives the productivity branch a more realistic timing layer than simply saying `work harder earlier`.

# Evidence In This Vault

- The current Daniel Pink productivity source explicitly recommends identifying `golden hours` and locking them for the Most Important Task.
...
- Compared with [[wiki/concepts/communication/timing-and-sequencing|Timing and Sequencing]], this concept is less about influence mechanics and more about aligning work with energy and cognition.
...
- Some roles offer little control over prime hours, which makes the model easier to endorse than to implement.
