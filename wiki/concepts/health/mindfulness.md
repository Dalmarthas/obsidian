...
related:
  ...
  - wiki/entities/kelly-mcgonigal.md
...
Mindfulness is present-moment awareness practiced with acceptance, nonjudgment, and a willingness to stay in contact with experience as it is. In the current vault, it is not generic relaxation, empty calm, or sheer concentration. It is a trainable stance that changes how thoughts, sensations, urges, and emotions are met.

# Why It Matters

- It gives the health branch a common base beneath habit change, stress regulation, and acceptance-based approaches to distress.
- It distinguishes helpful awareness from self-monitoring driven by fear, shame, or control.
- It offers a repeatable way to weaken avoidance and improve resilience without requiring every difficult state to disappear first.

# Evidence In This Vault

- [[wiki/sources/2026-04-11-ron-siegel-evidence-based-introduction-to-mindfulness]] defines mindfulness explicitly as awareness plus acceptance, kindness, and nonjudgment.
...
- Compared with [[wiki/concepts/health/mindful-curiosity|Mindful Curiosity]], mindfulness is broader. Mindful curiosity is one particularly active, investigative expression of mindfulness inside moments of urge and habit.
...
- The branch still needs clearer distinctions between mindfulness, concentration practice, relaxation training, and self-compassion, even when they overlap in practice.
...
- [[wiki/entities/kelly-mcgonigal|Kelly McGonigal]]
