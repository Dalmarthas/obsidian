...
related:
  ...
  - wiki/concepts/health/nighttime-awakenings.md
...
Circadian alignment is the practice of giving the body strong time-of-day signals so sleep onset, sleep continuity, alertness, and temperature rhythms line up more reliably. In the current branch, the strongest signals are morning bright light and evening darkness.

# Why It Matters

- It makes sleep easier by working with the body's timing system instead of fighting it.
- It is one of the most scalable sleep interventions because it changes the daily rhythm rather than only bedtime behavior.
- It matters especially for shift work, travel, irregular schedules, and delayed sleep patterns.

# Evidence In This Vault

- The Rhonda Patrick branch emphasizes at least 30 minutes of bright light exposure soon after waking.
- The Huberman source reinforces the same morning-light anchor and sharpens the operational detail: outdoor light soon after waking is preferred, windows weaken the effect, and cloud cover changes the needed duration.
- It also emphasizes dimmer evenings and reduced blue-light exposure to avoid suppressing melatonin.
- Consistent sleep and wake timing are treated as part of circadian support rather than mere discipline theater.
...
- [[wiki/concepts/health/nighttime-awakenings|Nighttime Awakenings]]
