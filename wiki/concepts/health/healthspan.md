...
related:
  ...
  - wiki/entities/pavel-tsatsouline.md
  - wiki/concepts/health/aging-as-disease.md
...
Healthspan is the portion of life lived with strong function, low disease burden, and real physical and cognitive capacity rather than mere survival. In this vault, the term becomes a useful bridge between preventive nutrition, sleep quality, and the broader question of whether extra years are actually livable years.

# Why It Matters

- It stops longevity from collapsing into "staying alive longer."
- It gives the health branch a target that is easier to reason about than lifespan alone.
- It connects daily health behaviors to quality of life, not just to abstract risk reduction.

# Evidence In This Vault

- The Michael Greger source explicitly contrasts lifespan with healthspan and argues that poor diet can lengthen the period of life spent disabled or chronically ill.
- The same branch treats whole-food, plant-based eating and exercise as tools for preserving function, not only for avoiding death.
- The Rhonda Patrick sleep branch contributes a parallel logic: better sleep quality protects restoration, cognition, and day-to-day function, which are part of healthspan even when the branch is not framed in longevity language.
...
- Michael Greger is strongest on long-horizon disease burden and functional years of life.
- The longevity composite branch is strongest on the aging-and-medicine frame: it asks why medicine targets late disease more readily than the process of decline itself.
...
- Healthspan can become a vague wellness slogan unless it stays tied to concrete levers and measurable function.
...
- [[wiki/sources/2026-04-08-michael-greger-plant-based-nutrition|Michael Greger Plant-Based Nutrition]]
- [[wiki/sources/2026-04-08-longevity-health-tips-composite-summary|Longevity Health Tips Composite Summary]]
- [[wiki/sources/2026-04-08-pavel-tsatsouline-strength-and-conditioning|Pavel Tsatsouline Strength and Conditioning]]
- [[wiki/entities/david-sinclair|David Sinclair]]
- [[wiki/entities/michael-greger|Michael Greger]]
- [[wiki/entities/pavel-tsatsouline|Pavel Tsatsouline]]
- [[wiki/concepts/health/brain-health-and-cognitive-aging|Brain Health and Cognitive Aging]]
- [[wiki/concepts/health/aging-as-disease|Aging as Disease]]
- [[wiki/concepts/health/whole-food-plant-based-diet|Whole-Food Plant-Based Diet]]
- [[wiki/concepts/health/diet-and-chronic-disease|Diet and Chronic Disease]]
