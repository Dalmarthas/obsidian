...
Two-systems thinking is the model that human judgment is shaped by two interacting modes: a fast associative mode that generates impressions automatically and a slower effortful mode that can inspect, refine, or override those impressions. In the current vault, this is the main framework for explaining why people can be both impressively intuitive and predictably biased at the same time. Main source: [[wiki/sources/2026-04-10-daniel-kahneman-two-systems-thinking|Daniel Kahneman Two-Systems Thinking]].

# Why It Matters

- It gives the vault a reusable explanation for why first impressions feel compelling before they are checked.
- It links bias, effort, self-control, and decision quality into one coherent model.
- It clarifies why procedures such as checklists, premortems, and explicit evidence review are often necessary rather than bureaucratic excess.

# Evidence In This Vault

- The Daniel Kahneman source defines `System 1` as fast, automatic, associative, and low-effort.
...
- The model is powerful, but it can become too binary if people forget that it is an explanatory simplification rather than a literal map of the brain.
- Knowing about fast and slow thinking does not guarantee that slow thinking will engage when it should.
- The vault still needs stronger overlap with sources on debiasing, checklists, forecasting, and decision design.
