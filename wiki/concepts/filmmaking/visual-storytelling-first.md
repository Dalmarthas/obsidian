...
Visual storytelling first is the rule that a screenplay should convey story pressure, information, and emotional movement through action, image, staging, and behavior before leaning on explanatory speech. In the current vault, dialogue is strongest when it enhances the visual-dramatic layer rather than replacing it.

# Why It Matters

- It prevents the screenplay from becoming exposition with bodies attached.
- It strengthens the connection between screenwriting and filmmaking as a visual medium rather than a transcript medium.
- It gives the vault a cleaner dialogue rule than `make the lines better`: often the real fix is to move the storytelling burden away from speech.

# Evidence In This Vault

- The dialogue roundtable states the principle directly: great screenplays tell through action and visuals first, with dialogue as support.
