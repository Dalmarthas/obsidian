...
- The current `Social Network` source sharpens the performance consequence: when the script's force depends heavily on exact rhythm and rhetorical timing, rehearsal may need to be extensive and improvisation deliberately restricted.
...
- The current Sorkin case study is strongest on load-bearing precision: the denser and more rhythm-dependent the page becomes, the more the production may need exact execution rather than loose paraphrase.
