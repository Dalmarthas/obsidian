...
- It determines whether people hear the message as something relevant to them or as distant performance.
- It helps turn abstract policy or strategy into lived stakes.
- It supports negotiation and trust-building across disagreement.
- It gives the vault a reusable home for future speaking, persuasion, and narrative leadership sources.

# Evidence In This Vault

- Conversational style shows respect and makes the audience feel addressed directly.
- Most communication impact comes from tone, presence, gesture, and authenticity rather than literal words alone.
...
- [[wiki/sources/2026-04-12-jordan-peterson-guide-to-leadership]] adds an organizational-story version: leadership communication should explain not only what the organization does, but why the destination is ethically worthwhile, why the collaboration is mutually beneficial, and why a follower should want to inhabit the role being offered.
- [[wiki/sources/2026-04-12-your-job-is-not-to-motivate-people]] sharpens that Peterson layer with a cleaner operational sequence:
  - here is the goal
  - here is your role
