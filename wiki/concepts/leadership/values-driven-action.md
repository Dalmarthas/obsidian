...
Values-driven action is the principle of organizing difficult effort around stable personal values rather than around fleeting desire, mood, or prestige-chasing goals. In the current vault, the concept matters because it explains how people keep moving when emotions cool off, shortcuts lose their novelty, and external validation becomes unreliable.

# Why It Matters

- It gives the leadership branch a cleaner distinction between durable motivation and unstable excitement.
- It helps explain why some self-improvement attempts survive discomfort while others collapse once the emotional wave passes.
- It connects meaning, agency, and action without reducing motivation to either hacks or moralistic willpower talk.

# Evidence In This Vault

- The current source argues that desire and emotion are too volatile to sustain long-term excellence by themselves.
- That same source treats values as the deeper layer that can justify discomfort, repetition, and delayed payoff.
...
- Values language can become vague theater if people name noble ideals that never alter what they actually do.
