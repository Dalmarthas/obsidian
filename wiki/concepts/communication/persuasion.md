...
Persuasion is the practice of moving people toward action, understanding, or changed judgment without relying on crude pressure, falsehood, or theatrical domination. In the current source base, the strongest version is human-centered: shape context, understand the other side, reduce friction, and make action feel both meaningful and self-authored.

# Why It Matters

- It gives the vault a canonical home for influence that is broader than negotiation and broader than public speaking.
- It reframes persuasion as a daily operating skill rather than a specialized sales trick.
- It links communication, motivation, timing, and ethical conduct into one reusable branch.
- It helps the wiki distinguish humane influence from manipulation.
