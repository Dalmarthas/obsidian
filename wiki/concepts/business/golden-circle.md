...
The Golden Circle is Simon Sinek's inside-out framework for explaining leadership, brands, sales, and action through three concentric layers: `why`, `how`, and `what`. In this vault, the concept is not just a speaking trick. It is a way of testing whether a company or leader is communicating from purpose and belief first, or merely listing outputs and hoping the audience will care afterward.

# Why It Matters

- It gives the vault a reusable model for purpose-led messaging across business, leadership, and persuasion.
- It sharpens the difference between feature explanation and belief transmission.
- It now has a stronger one-to-one sales application, not only a keynote or brand-identity application.
- It links brand language to deeper questions about values, trust, and strategic coherence.
- It creates a more concrete bridge between Simon Sinek's communication model and his later infinite-game thinking.

# Evidence In This Vault

- The Golden Circle source states that the most inspiring communicators begin with `why`, then explain `how`, and only afterward describe `what`.
- The same source argues that people often commit to beliefs and identity first, then rationalize the choice later.
...
- Purpose-first communication can become empty theater when the `why` is too generic or disconnected from actual tradeoffs.
