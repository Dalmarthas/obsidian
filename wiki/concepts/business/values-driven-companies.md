...
Values-driven companies are organizations that explicitly try to align commercial performance with humane treatment, cultural coherence, and a larger sense of purpose rather than treating ethics as optional decoration around profit. In the current source base, this is not charity detached from business reality. It is an operating philosophy that still demands strong execution.

# Why It Matters

- It gives the vault a clearer home for the recurring question of whether companies can be both commercially strong and morally serious.
- It links business performance to internal dignity, external trust, and brand meaning.
- It prevents `values` from remaining a vague leadership slogan without operational consequences.

# Evidence In This Vault

- Schultz is the clearest current source: values and profits are not enemies, but financial performance is the price of admission to living the values at scale.
...
- The Steve Jobs `Think Different` source adds an endurance test for values:
  - products, markets, and tactics can change dramatically while core beliefs remain stable
  - values matter not only inside culture but in how the company explains itself publicly
