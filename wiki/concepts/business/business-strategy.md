...
- It turns ambition into focus by making some priorities explicit and others secondary.
- It connects leadership rhetoric to concrete allocation decisions, product choices, and execution discipline.
- It prevents teams from mistaking motion in marketing or sales for actual strategic progress.

# Evidence In This Vault

- Iger's framework is explicit: invest in creativity, embrace technology, and grow globally.
...
- The Seth Godin strategy source adds a posture layer: strategy is the relatively fixed answer to `who is it for?` and `what change are we trying to make?`, while tactics are expected to adapt.
...
- Christensen adds a metrics tension: financially elegant ratios can make a company look disciplined while steadily hollowing out its future growth engine.
- Ries adds a neighboring tension: even when companies claim to support innovation, they may still measure new work with metrics that reward presentation quality more than learning quality.
- Sinek adds a cultural version of that same problem: companies may praise trust, integrity, and sustainability while compensating only for short-term spikes or status signals.
