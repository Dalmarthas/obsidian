...
- Lynch treats ideas as things to be caught, written down immediately, and then translated into simple written cues, scene headings, or cards before they are over-explained.
...
- Lynch is strongest on receptive conditions plus light externalization: make space, protect daydreaming, catch the idea before it sinks again, and preserve it in simple written forms before density kills the signal.
